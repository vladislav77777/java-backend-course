    ...
    public void testFetchQuestion() {
        ...
        WIRE_MOCK_SERVER.stubFor(get(urlEqualTo("/questions/1?site=stackoverflow&filter=withbody"))
            .willReturn(aResponse()
                ...
                .withBody(
                    "{ \"items\": [{\"owner\": {\"display_name\": \"123_ab\"}, \"last_activity_date\": 1645718400, \"creation_date\": 1645711400, \"answer_id\": 456, \"body\": \"This is the answer.\"}]}")));
        ...
        assertEquals("123_ab", item.owner().display_name());
        assertEquals(
